...
import de.greenrobot.dao.attention.Marker;
...
public class MarkerDao extends AbstractDao<Marker, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property RecordName = new Property(2, String.class, "recordName", false, "RECORD_NAME");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MARKER\" (" + //
                ...
                "\"RECORD_NAME\" TEXT NOT NULL );"); // 2: recordName
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Marker entity) {
        ...
        stmt.bindString(3, entity.getRecordName());
    }
    ...
    public Marker readEntity(Cursor cursor, int offset) {
        Marker entity = new Marker( //
            ...
            cursor.getString(offset + 2) // recordName
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Marker entity, int offset) {
        ...
        entity.setRecordName(cursor.getString(offset + 2));
     }
