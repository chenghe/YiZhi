...
public class TextViewExpandableAnimation extends LinearLayout
    ...
    private void initValue(Context context, AttributeSet attrs) {
        ...
        textViewStateColor = ta.getColor(
            R.styleable.TextViewExpandableAnimation_tvea_textStateColor, ContextCompat
                .getColor(context, R.color.expend_text_color));
        ...
        if (null == drawableShrink) {
            drawableShrink = ContextCompat.getDrawable(context, R.drawable.close);
        }

        if (null == drawableExpand) {
            drawableExpand = ContextCompat.getDrawable(context, R.drawable.open);
        }
        ...
        textContentColor = ta.getColor(
            R.styleable.TextViewExpandableAnimation_tvea_textContentColor, ContextCompat
                .getColor(context, R.color.little_black));
        textContentSize = ta.getDimension(
            R.styleable.TextViewExpandableAnimation_tvea_textContentSize, 14);
    ...
    private void initView(Context context) {
        ...
        rlToggleLayout = (RelativeLayout) findViewById(
            R.id.rl_expand_text_view_animation_toggle_layout);

        textView = (TextView) findViewById(R.id.tv_expand_text_view_animation);
        textView.setTextColor(textContentColor);
        textView.setLineSpacing(getResources().getDimensionPixelSize(R.dimen.text_space), 1.1f);
