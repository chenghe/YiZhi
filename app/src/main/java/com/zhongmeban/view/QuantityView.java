...
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    private String labelDialogTitle = "修改购买数量";
    private String labelPositiveButton = "确定";
    private String labelNegativeButton = "取消";
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mButtonRemove.setPadding(dp16, dp10, dp16, dp10);
                ...
                public void onClick(View v) {
                    ...
                    if (isValidNumber(newQuantity)) {
                        ...
                        if (intNewQuantity > maxQuantity) {
                            Toast.makeText(getContext(), "因库存紧张最多 " + maxQuantity, Toast.LENGTH_LONG).show();
                        } else if (intNewQuantity < minQuantity) {
                            Toast.makeText(getContext(), "至少选一件 " + minQuantity, Toast.LENGTH_LONG).show();
                        } else {
                        ...
                        Toast.makeText(getContext(), "无效的数量", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
