...
public class ReadMoreTextView extends TextView {
    /**
     * 使用注意事项，当需要隐藏内容布局的时候，切记不能使用gone，用invisialbe，否则
     * 当前控件无法计算textview的高度，而不能正确显示折叠
     */
    ...
    public ReadMoreTextView(Context context, AttributeSet attrs) {
        ...
        this.trimLength = typedArray.getInt(R.styleable.ReadMoreTextView_trimLength,
            DEFAULT_TRIM_LENGTH);
        ...
        int resourceIdTrimExpandedText =
            typedArray.getResourceId(R.styleable.ReadMoreTextView_trimExpandedText,
                R.string.read_less);
    ...
    private CharSequence updateExpandedText() {
        if (showTrimExpandedText) {
            SpannableStringBuilder s = new SpannableStringBuilder(text, 0, text.length()).append(
                trimExpandedText);
    ...
    private class ReadMoreClickableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            refreshLineEndIndex("ReadMoreClickableSpan");
            setText();
        }
            ...
            getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        refreshLineEndIndex("onGlobalLayoutLineEndIndex");
                        setText();
                    }
                });
        }
    ...
    @Override protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //refreshLineEndIndex("onSizeChanged");
        //setText();
    }
    ...
    @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        refreshLineEndIndex("onMeasure");
        setText();

    }


    public void refreshLineEndIndex(String methodName) {
        ...
        Logger.d(methodName+"--行数==" + lineEndIndex + "==" + getLineCount() + "==" + trimLines);
    }
}