...
public class AttentionHospChoosePresenter implements AttentionHospChooseContract.Presenter {

    public static final String CHOOSE_HOSP_BEAN = "ChooseHospBean";
    public static final String AttentionHospName = "attentionHospName";
    public static final String AttentionHospId = "attentionHospId";
    public static final String AttentionHospChoose = "attentionHospChoose";
    public static final int AttentionChooseHospOk = 200;

    private Context mContext;
    private AttentionHospChooseContract.View view;
    ...
    public AttentionHospChoosePresenter(AttentionHospChooseContract.View view, Context mContext) {
    ...
    @Override
    public Intent finishChoose(Intent intent, int position) {
        intent.putExtra(AttentionHospName, httpList.get(position).getName());
        intent.putExtra(AttentionHospId, httpList.get(position).getId());
        return intent;
    }

    @Override
    public Intent finishChoose(Intent intent) {
        Intent chooseIntent = new Intent();
        String  name = intent.getStringExtra(AttentionHospName);
        int id = intent.getIntExtra(AttentionHospId,0);
        chooseIntent.putExtra(AttentionHospName,name);
        chooseIntent.putExtra(AttentionHospId,id);
        return chooseIntent;
    }
