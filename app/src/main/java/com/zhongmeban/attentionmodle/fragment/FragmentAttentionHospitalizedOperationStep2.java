...
// */
//
//public class FragmentAttentionHospitalizedOperationStep2 extends BaseFragment implements View.OnClickListener {
//
...
//
//            case R.id.rl_type:
//                Intent intent2 = new Intent(parentActivity, ActivityAttentionTherapeuticByDisId.class);
//                intent2.putExtra("diseaseId",parentActivity.patientDiseaseId);
