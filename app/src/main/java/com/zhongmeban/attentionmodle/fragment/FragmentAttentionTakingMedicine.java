 ...
 */
public class FragmentAttentionTakingMedicine extends BaseFragmentRefresh {
    ...
    public static FragmentAttentionTakingMedicine newInstance() {

        Bundle args = new Bundle();

        FragmentAttentionTakingMedicine fragment = new FragmentAttentionTakingMedicine();
        ...
        Observable.create( new Observable.OnSubscribe<MedicineRecord>(){
            ...
            public void call(Subscriber<? super MedicineRecord> subscriber) {
                ...
                dataList =  medicineRecordDao.queryBuilder()
                        .where(medicineRecordDao.queryBuilder().and(MedicineRecordDao.Properties.Status.eq(1),
                ...
                userInfoSp.edit().putInt("takingMedicine",dataList.size()).commit();
                ...
                .subscribe(new Subscriber<MedicineRecord>() {
                    ...
                    public void onCompleted() {
                        Log.i("hcb","FragmentAttentionTakingMedicine onCompleted");
                        if (dataList.size()>0){
                            //判断是否有数据
                            showEmptyLayoutState(LOADING_STATE_SUCESS);
...
//                        mAdapter.updateData(dataList);
                    ...
                    public void onError(Throwable e) {
                        Log.i("hcb","FragmentAttentionTakingMedicine onError");
                        Log.i("hcb","e"+e);
                        showEmptyLayoutState(LOADING_STATE_EMPTY);
                    ...
                    public void onNext(MedicineRecord medicineRecord) {
                        Log.i("hcb","FragmentAttentionTakingMedicine onNext");
                    }
                });
    }
