 ...
 */
public class ActTreatment extends BaseActivity {

    private Context mContext = ActTreatment.this;
    ...
    private List<TreatCategoryLists.TreatCategorySource> therapeuticList
        = new ArrayList<TreatCategoryLists.TreatCategorySource>();//癌症list
            ...
            .subscribe(new Subscriber<Tumor>() {
                ...
                public void onCompleted() {
                    ...
                    if (diseasesList.size() > 0) {
                        ...
                        diseaseId = (int) diseasesList.get(0).getId();
    ...
    private void initView() {
        ...
        rightListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                boolean isBaXiangZhiLiao = Integer.valueOf(therapeuticList.get(position).getId())== Constants.BA_XIANG_ZHI_LIAO;

                intent.putExtra(ActivityTreatByDis.EXTRA_IS_BAXIANGZHILIAO, isBaXiangZhiLiao);
