...
/**
 * @Description:医院列表中医生ListView Adapter 1.0.1
 * Created by Chengbin He on 2016/4/5.
 */
public class TreatHospDoctAdapter extends BaseAdapter{
    public String imageUrl = ImageUrl.BaseImageUrl;
    private Context mContext;
    private List<TreatDoctor> list;

    public TreatHospDoctAdapter(Context mContext, List<TreatDoctor> list){
