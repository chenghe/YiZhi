...
/**
 * Description:医师列表Activity对应RecyclerView Adapter
 * Created by Chengbin He on 2016/3/30.
 */
public class DoctListsAdapter extends BaseRecyclerViewAdapter {

    private Context mContext;
    private List<Doctor> list;

    public DoctListsAdapter(Context mContext, List<Doctor> list) {
...
//            if (list.get(position).getAvatar()!= null){
                ...
                Log.i("hcb", "url is " + ImageUrl.BaseImageUrl + url);
                Picasso.with(mContext).load(ImageUrl.BaseImageUrl+url).placeholder(R.drawable.doc_list_small).error(R.drawable.doc_list_small)
