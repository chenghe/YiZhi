 ...
 * 治疗方法--放疗
 */
public class TreatRadiotherapyFragment extends BaseFragmentRefresh {
    ...
    public static TreatRadiotherapyFragment newInstance(int cancleId) {
        TreatRadiotherapyFragment fragment = new TreatRadiotherapyFragment();
    ...
    private void getData() {
        ...
        HttpService.getHttpService().getRadiotherapyList(cancerId)
