 ...
 * 治疗方法--放疗
 */
public class TreatChemotherapyFragment extends BaseFragmentRefresh {
    ...
    public static TreatChemotherapyFragment newInstance(int cancleId) {
        TreatChemotherapyFragment fragment = new TreatChemotherapyFragment();
    ...
    private void getData() {
        ...
        HttpService.getHttpService().getChemotherapyList(cancerId)
