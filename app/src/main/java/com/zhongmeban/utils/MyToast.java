...
/**
 * Description: 自定义吐司的显示时间
 * user: Chong Chen
 * time：2015/12/29 16:21
...
//        mLayout.setBackground(g);
    ...
    public static final int LENGTH_ONE = 1000; //自定义显示时间一秒钟
    public static final int LENGTH_SHORT = 2000;//短显示时间
    public static final int LENGTH_LONG = 3500;//长显示时间
