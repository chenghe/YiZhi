...
public class AESOperator {
     ...
     */
    //    private String sKey = "16BytesLengthKey";//key，可自行修改
    private String ivParameter = "16-Bytes--String";//偏移量,可自行修改
    private static AESOperator instance = null;
    private static final String AppId = "zhongmeban";
    ...
    public String encrypt(String sSrc, String sKey) throws Exception {
        ...
        IvParameterSpec iv = new IvParameterSpec(
            ivParameter.getBytes());// 使用CBC模式，需要一个向量iv，可增加加密算法的强度
        cipher.init(Cipher.ENCRYPT_MODE, skeySpec, iv);
 ...
 */
    public static String getKey(String userId) {
        ...
        return MD5Util.string2MD5(AppId + userId).substring(8, 24);
    }
